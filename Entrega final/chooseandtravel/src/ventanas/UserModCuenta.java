...
/**
 *
 * Ventana por parte del Cliente que modifica su contraseña
 * 
...
public class UserModCuenta extends javax.swing.JFrame {
  ...
  Sistema sistema;
     ...
     * @param sis Parametro Sistema que es la memoria del programa
     */
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        if (pass.getText() != "" && newPass.getText() != "" || pass.getText() != "" && newPass.getText() != null
                            ...
                            if(mCuent.modPassUser(sistema.getCuentas(), sistema.getSesion(), newPass.getText(),pass.getText())){
                               dispose();
