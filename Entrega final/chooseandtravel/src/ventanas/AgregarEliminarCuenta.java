...
/**
 * Ventana de parte del administrador que agrega o elimina un Cliente
 * 
            ...
            if (inputUser.getText() != "") {
                if(agregar.isSelected()){
                    if (inputPass.getText() != "" && inputNombre.getText() != "" || inputPass.getText() != "" && inputNombre.getText() != null
                            ...
                            mCuentas.agregarCuenta(inputUser.getText(), inputPass.getText(), inputNombre.getText(), mSuc.getCodigoNomn((String) inputSucursal.getSelectedItem(),sistema.getSucursales()),sistema.getCuentas());
